    ...
    <div className="section-padding bg-white">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <h2 className="mb-3">1. Datos Identificativos</h2>
          <p>
          ...
          <ul>
            ...
            <li>
              <strong>Email:</strong> info@cos-ors.com
            </li>
          </ul>
          <h1 className="mb-8"></h1>
          ...
          <h2 className="mb-3">3. Condiciones de Uso</h2>
          <p>
          ...
          <h2 className="mb-3">4. Uso Autorizado</h2>
          ...
          <h2 className="mb-3">6. Exclusión de Garantías y Responsabilidad</h2>
          <p>
          ...
          <h2 className="mb-3">8. Legislación Aplicable</h2>
          <p>
